...
const WindowTintPage = () => {
  return (
    <VehicleLayout>
      ...
      <div className="relative z-0 w-full h-full">AAAAAA</div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full pointer-events-none">
        <h2 className="mb-2 text-white uppercase text-sm md:text-xl lg:text-2xl font-bold text-center px-4">AAAAA</h2>
